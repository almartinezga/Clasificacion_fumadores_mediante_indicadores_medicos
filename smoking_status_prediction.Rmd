---
title: "Prediction of smokers through bio signals"
author: 
- Enrique Olvera
- Alberto Martinez
- Daniel Ibarra
...
head(dataset)      # First 6 filas
tail(dataset)      # Last 6 filas
...
The dataset has 159,256 observations and 24 variables.
...
```
After applying a thorough filter to the data, the data set is left with 139,585 rows and 22 columns
...
par(las=2)
```
Elevated levels are plausible due to health problems.
